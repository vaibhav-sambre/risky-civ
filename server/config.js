...
const TECH_TREE = {
    military: [
        ...
        { id: 'mil_t6', name: 'Siege Tactics', cost: 120, description: 'Ignore target\'s "Fortify" and structure defensive bonuses when attacking', effect: 'siegeTactics' },
        { id: 'mil_t7', name: 'Guerilla Warfare', cost: 150, description: 'When defending, guaranteed to inflict at least 1 casualty', effect: 'guerillaWarfare' },
        { id: 'mil_t8', name: 'Combined Arms', cost: 200, description: 'Attack with up to 5 dice instead of 3', effect: 'combinedArms' },
    ],
    economic: [
        ...
        { id: 'eco_t5', name: 'Banking Guild', cost: 120, description: 'All Banks provide +4 Money instead of +2', effect: 'bankingGuild' },
        { id: 'eco_t6', name: 'Tax Havens', cost: 160, description: 'Troop upkeep costs permanently reduced to 0.5 per troop', effect: 'taxHavens' },
        { id: 'eco_t7', name: 'Industrial Espionage', cost: 200, description: 'Passively gain resources equal to 10% of enemy\'s income each turn', effect: 'industrialEspionage' },
    ],
    science: [
        ...
        { id: 'sci_t5', name: 'Logistics Network', cost: 120, description: 'Max actions increased from 4 to 5 per turn', effect: 'logisticsNetwork' },
        { id: 'sci_t6', name: 'Scientific Method', cost: 160, description: 'Base research output from all sources is doubled', effect: 'scientificMethod' },
        { id: 'sci_t8', name: 'World Domination', cost: 300, description: 'Instant victory — you win!', effect: 'worldDomination' },
    ],
};
