...
const BONUS_CARDS = [
    ...
    { id: 'res_ex01', name: 'Brain Drain', category: 'research', type: 'bonus', cost: 8, description: 'Steal 20 Research from the enemy.', icon: '🧠' },
    { id: 'res_ex02', name: 'Reverse Engineering', category: 'research', type: 'bonus', cost: 6, description: 'Gain +30 Research if the enemy has more tech unlocked than you.', icon: '🔧' },
    { id: 'res_ex03', name: 'Space Program', category: 'research', type: 'bonus', cost: 12, description: 'Gain +50 Research immediately.', icon: '🚀' },
