...
import { MAX_ATTACK_DICE, MAX_DEFEND_DICE, MIN_GARRISON } from './config.js';
...
export function resolveCombatRound(state, attackId, defendId, attackCount) {
...
export function applyCombatResult(state, attackId, defendId, result, troopsCommitted) {
    const attacker = getTerritory(state.territories, attackId);
    const defender = getTerritory(state.territories, defendId);
